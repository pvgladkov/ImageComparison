/* 
 * File:   CustomCannyDetector.cpp
 * 
 * Created on 20 Январь 2013 г., 19:50
 */

#include "CustomCannyDetector.h"
#include <math.h>
#include <opencv2/core/core.hpp>

CustomCannyDetector::CustomCannyDetector() {
...
CustomCannyDetector::CustomCannyDetector(const CustomCannyDetector& orig) {
}
...
inline uint8_t CustomCannyDetector::GetPixelValue(unsigned int x, unsigned int y) {
	return (uint8_t) *(workspace_bitmap + (unsigned long) (x * width + y));
}

inline void CustomCannyDetector::SetPixelValue(unsigned int x, unsigned int y,
                                             uint8_t value) {
...
void CustomCannyDetector::PreProcessImage(float sigma)
{
...
void CustomCannyDetector::PostProcessImage()
{
...
void CustomCannyDetector::Luminance()
{
	unsigned long i;
...
void CustomCannyDetector::GaussianBlur(float sigma)
{
...
void CustomCannyDetector::EdgeDetection()
{
	// Sobel masks.
	float Gx[9];
...
void CustomCannyDetector::NonMaxSuppression() {
...
void CustomCannyDetector::Hysteresis(uint8_t lowThreshold, uint8_t highThreshold) {
...
void CustomCannyDetector::HysteresisRecursion(long x, long y, uint8_t lowThreshold){
